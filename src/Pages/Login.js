...
import SignUpForm from '../Components/SignupForm'; // Import du formulaire d'inscription
...
const classes = {
  drawer: {
    ...
    '& .MuiDrawer-paper': { // Sélecteur pour le papier du tiroir
...
export default function Login() {
  return (
    <Box sx={classes.root}> {/* Boîte principale */}
      ...
      <Box sx={{ width: '100%' }}> {/* Boîte pour contenir les onglets de connexion et d'inscription */}
